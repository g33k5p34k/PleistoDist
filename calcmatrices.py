...
path = os.getcwd()
inputpath = "examples/output/" #edit this if you want to change the output directory
outpath = "examples/output/" #edit this if you want to change the output directory
